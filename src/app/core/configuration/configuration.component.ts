...
export class ConfigurationComponent implements OnInit {
  ...
  autoCloseOptionList: SelectItem[] = [];
  openHelpText = false;
  openHelpText1 = false;
  openHelpText2 = false;
  openHelpText3 = false;
  ...
  openHelpText8 = false;
  openHelpText9 = false;
  openHelpText10 = false;
  openHelpText11 = false;
  openHelpText12 = false;
  openHelpText13 = false;
  ...
  ngOnInit(): void {
    ...
    this.autoCloseOptionList = [{ label: 'Yes', value: true }, { label: 'No', value: false }];
    ...
    this.configurationService.get().subscribe((data: any) => {
      ...
      this.configuration.stationaryShipmentTimeSeconds = this.procesTime(
        'view',
        this.configuration.stationaryShipmentTimeSeconds
      );
      this.configuration.autocloseorderafter = this.procesTime(
        'view',
        this.configuration.autocloseorderafter
      );
      this.configuration.autocloseshipmentafter = this.procesTime(
        'view',
        this.configuration.autocloseshipmentafter
      );
      ...
      this.configurationForm.patchValue({
        ...
        autocloseorder: this.configuration.autocloseorder,
        autocloseorderafter: this.configuration.autocloseorderafter,
        autocloseshipment: this.configuration.autocloseshipment,
        autocloseshipmentafter: this.configuration.autocloseshipmentafter,
  ...
  prepareForm() {
    this.configurationForm = this.fb.group({
      ...
      isAutoShipMode: [''],
      autocloseorder: [''],
      autocloseorderafter: [0, Validators.min(0)],
      autocloseshipment: [0, Validators.min(0)],
  ...
  onSubmit(value: any) {
    ...
    value.stationaryShipmentTimeSeconds = value.stationaryShipmentTimeSeconds
      ...
      : 0;
    value.autocloseorderafter = value.autocloseorderafter ? value.autocloseorderafter : 0;
    value.autocloseshipmentafter = value.autocloseshipmentafter ? value.autocloseshipmentafter : 0;
    value.stationaryShipmentTimeSeconds = this.procesTime(
      'save',
      value.stationaryShipmentTimeSeconds
    );
    value.autocloseorderafter = this.procesTime(
      'save',
      value.autocloseorderafter
    );
    value.autocloseshipmentafter = this.procesTime(
      'save',
      value.autocloseshipmentafter
    );
  ...
  setFlagForHelptext10(flag: boolean) {
    this.openHelpText10 = flag;
  }
  setFlagForHelptext11(flag: boolean) {
    this.openHelpText11 = flag;
  }
  setFlagForHelptext12(flag: boolean) {
    this.openHelpText12 = flag;
  }

  setFlagForHelptext13(flag: boolean) {
    this.openHelpText13 = flag;
  }
